...
function ultimatecrawloptimizer_settings()
{
    ...
    add_submenu_page('my-theme-settings', 'Robots.txt Optimization', 'Robots.txt Optimization', 'manage_options', 'my-theme-settings-robots', 'ultimatecrawloptimizer_settings_robots_page');
    add_submenu_page('my-theme-settings', 'Htaccess Optimization', 'Htaccess Optimization', 'manage_options', 'my-theme-settings-htaccess', 'ultimatecrawloptimizer_settings_htaccess_page');
}
